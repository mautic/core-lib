...
class ReportExporterTest extends \PHPUnit\Framework\TestCase
{
    public function testProcessExport(): void
    {
        ...
        $eventDispatcher->expects($matcher)
            ->method('dispatch')->willReturnCallback(function (ReportScheduleSendEvent|JobExtendTimeEvent $event, ?string $eventName) use ($matcher, $scheduler1, $scheduler2, $schedulerNow): \Mautic\CoreBundle\Event\JobExtendTimeEvent|\Mautic\ReportBundle\Event\ReportScheduleSendEvent {
