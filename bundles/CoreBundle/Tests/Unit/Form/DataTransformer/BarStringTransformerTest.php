...
final class BarStringTransformerTest extends TestCase
{
    ...
    public function testTransform(int|\stdClass|string|array|null $value, string $expected): void
    {
    ...
    public function testReverseTransform(int|\stdClass|string|array|null $value, array $expected): void
    {
        $transformer = new BarStringTransformer();
