...
final class PageImportExportSubscriber implements EventSubscriberInterface
{
    ...
    public function onPageExport(EntityExportEvent $event): void
    {
        ...
        $pageData = [
            ...
            'variant_start_date'     => $page->getVariantStartDate(),
            'variant_sent_count'     => $page->getVariantSentCount(),
            'variant_read_count'     => $page->getVariantReadCount(),
            ...
            'translation_parent_id'  => $page->getTranslationParent(),
            'variant_parent_id'      => $page->getVariantParent(),
